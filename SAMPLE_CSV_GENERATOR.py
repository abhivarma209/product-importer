...
def generate_csv_with_duplicates(filename='products_with_duplicates.csv', num_records=1000):
    ...
    print(f"\n✅ Successfully generated {filename} with {num_records + num_duplicates} total records!")
    print(f"   ({num_records} unique + {num_duplicates} duplicates)")
    print(f"File size: {get_file_size(filename)}")


def generate_large_csv(filename='large_products.csv', num_records=50000):
    """
    ...
    Args:
        ...
        num_records: Number of records to generate
    """
    print(f"Generating LARGE CSV with {num_records} records...")
    print("This may take a few minutes...")
    
    generate_sample_csv(filename, num_records)
...
if __name__ == '__main__':
    ...
    if num_records > 1000:
        generate_large_csv('large_products.csv', num_records)
        print()
